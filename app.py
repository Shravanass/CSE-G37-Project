...
crop_image_urls = {
    ...
    "Chickpea": "/static/chickpeas.jpg",
    "Coffee": "/static/coffee.jpg",
    }
# Add more crop-image mappings as needed
# }
...
def predict():
    ...
    feature_list = [N, P, K, temp, humidity, ph, 0]
    ...
    if prediction[0] in crop_dict:
        ...
        result_crop_image = crop_image_urls.get(crop, None)
    else:
        result = "Sorry, we could not determine the best crop to be cultivated with the provided data."
    return render_template('index.html',result = result, result_crop_image=result_crop_image)
